			...
			<div class="buy_title">
		 	...
		 	<div class="buy_info">
		 		<div class="buy_imfo_img">
		 			<img src="resources/img/buy/buyDetail/s1.jpg">
		 		</div>
		 		<div class="buy_info_rightbar">
			 		<fieldset class="buy_fieldset">
			 		<div class="buy_info_top">
			 			<h2 class="buy_info_h2">[수영장 일반 이용권]</h2>
			 		...
			 		<div class="buy_select">
			 			<select class="buy_select_contants">
			 				...
			 				<option value="">수영장 일반이용권 1개월 (100,000원)</option>
			 				<option value="">수영장 일반이용권 3개월 (300,000원)</option>
			 				<option value="">수영장 일반이용권 6개월 (600,000원)</option>
			 				<option value="">수영장 일반이용권 12개월 (1,200,000원)</option>
			 			</select>
			 		</div>
