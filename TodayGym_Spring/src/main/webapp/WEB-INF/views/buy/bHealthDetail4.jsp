			...
			<div class="buy_title">
		 	...
		 	<div class="buy_info">
		 		<div class="buy_imfo_img">
		 			<img src="resources/img/buy/buyDetail/h4.png">
		 		</div>
		 		<div class="buy_info_rightbar">
			 		<fieldset class="buy_fieldset">
			 		<div class="buy_info_top">
			 			<h2 class="buy_info_h2">[GX 프로그램 다이어트프로그램]</h2>
			 		...
			 		<div class="buy_select">
			 			<select class="buy_select_contants">
			 				<option disabled selected>&nbsp;&nbsp;&nbsp;GX 프로그램</option>
			 				<option value="">GX 프로그램 1개월 (400,000원)</option>
			 				<option value="">GX 프로그램 3개월 (1,200,000원)</option>
			 				<option value="">GX 프로그램 6개월 (2,400,000원)</option>
			 				<option value="">GX 프로그램 12개월 (4,800,000원)</option>
			 			</select>
			 		</div>
