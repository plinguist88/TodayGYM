			...
			<div class="buy_title">
		 	...
		 	<div class="buy_info">
		 		<div class="buy_imfo_img">
		 			<img src="resources/img/buy/buyDetail/cs3.jpg">
		 		</div>
		 		<div class="buy_info_rightbar">
			 		<fieldset class="buy_fieldset">
			 		<div class="buy_info_top">
			 			<h2 class="buy_info_h2">[크로스핏 중급레슨]</h2>
			 		...
			 		<div class="buy_select">
			 			<select class="buy_select_contants">
			 				<option disabled selected>&nbsp;&nbsp;&nbsp;크로스핏 중급레슨</option>
			 				<option value="">크로스핏 중급레슨 1개월 (300,000원)</option>
			 				<option value="">크로스핏 중급레슨 3개월 (900,000원)</option>
			 				<option value="">크로스핏 중급레슨 6개월 (1,800,000원)</option>
			 				<option value="">크로스핏 중급레슨 12개월 (3,600,000원)</option>
			 			</select>
			 		</div>
