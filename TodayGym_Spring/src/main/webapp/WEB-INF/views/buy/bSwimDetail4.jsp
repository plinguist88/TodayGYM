	...
	<div class="wrap">
		 		...
		 		<div class="buy_info_rightbar">
			 		...
			 		<div class="buy_select">
			 			<select class="buy_select_contants">
			 				<option disabled selected>&nbsp;&nbsp;&nbsp;수영 고급레슨</option>
			 				<option value="">수영 고급레슨 1개월 (400,000원)</option>
			 				<option value="">수영 고급레슨 3개월 (1,200,000원)</option>
			 				<option value="">수영 고급레슨 6개월 (2,400,000원)</option>
			 				<option value="">수영 고급레슨 12개월 (4,800,000원)</option>
			 			</select>
			 		</div>
		...
		<section class="buy_detail">
				...
				<fieldset>
					...
					<div class="videozone">
						<video class="healthvideo" muted autoplay loop>
							<source src="resources/video/swim.mp4" type="video/mp4">
						</video>
					</div>
					<div>
			...
			<script>
				...
				// 주소로 좌표를 검색합니다
				geocoder.addressSearch('인천광역시 주안동', function(result, status) {
			    ...
			    // 정상적으로 검색이 완료됐으면 
			     if (status === kakao.maps.services.Status.OK) {
			        ...
			        var infowindow = new kakao.maps.InfoWindow({
			            content: '<div style="width:150px;text-align:center;padding:6px 0;">TOGYM 수영본점</div>'
			        });
