		 		...
		 		<div class="buy_info_rightbar">
			 		...
			 		<div class="buy_select">
			 			<select class="buy_select_contants">
			 				<option disabled selected>&nbsp;&nbsp;&nbsp;크로스핏 초급레슨</option>
			 				<option value="">크로스핏 초급레슨 1개월 (200,000원)</option>
			 				<option value="">크로스핏 초급레슨 3개월 (600,000원)</option>
			 				<option value="">크로스핏 초급레슨 6개월 (1,200,000원)</option>
			 				<option value="">크로스핏 초급레슨 12개월 (2,400,000원)</option>
			 			</select>
			 		</div>
