			...
			<div class="buy_title">
		 	...
		 	<div class="buy_info">
		 		<div class="buy_imfo_img">
		 			<img src="resources/img/buy/buyDetail/h3.png">
		 		</div>
		 		<div class="buy_info_rightbar">
			 		<fieldset class="buy_fieldset">
			 		<div class="buy_info_top">
			 			<h2 class="buy_info_h2">[5:1 그룹 PT권]</h2>
			 		...
			 		<div class="buy_select">
			 			<select class="buy_select_contants">
			 				<option disabled selected>&nbsp;&nbsp;&nbsp;5:1 그룹 PT권</option>
			 				<option value="">5:1 그룹 PT권 1개월 (300,000원)</option>
			 				<option value="">5:1 그룹 PT권 3개월 (900,000원)</option>
			 				<option value="">5:1 그룹 PT권 6개월 (1,800,000원)</option>
			 				<option value="">5:1 그룹 PT권 12개월 (3,400,000원)</option>
			 			</select>
			 		</div>
